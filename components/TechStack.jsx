...
import { Database, Server, Layout, Code, Cpu, Workflow, Wrench } from 'lucide-react'
...
const skills = [
  ...
  { name: 'Google Agent SDK', icon: Cpu, category: 'AI', story: 'Building the agents of tomorrow' },
]
  ...
  return (
    <section id="tech-stack" className="py-24 px-6 bg-white/5 relative">
      <div ref={containerRef} className="container mx-auto max-w-6xl">
        ...
        <div ref={containerRef} className="skills-grid grid grid-cols-2 md:grid-cols-4 gap-6">
          {skills.map((skill) => (
            <div
              key={skill.name}
